...
static struct msm_board_data msm8x60_tenderloin_board_data __initdata = {
	.gpiomux_cfgs = msm8x60_tenderloin_gpiomux_cfgs,
};
...
static void __init msm8x60_tenderloin_init(void)
{
	msm8x60_init(&msm8x60_tenderloin_board_data);
}
...
MACHINE_START(MSM8X60_TENDERLOIN, "QCT MSM8X60 TENDERLOIN")
	.map_io = msm8x60_map_io,
	.reserve = msm8x60_reserve,
	.init_irq = msm8x60_init_irq,
	.init_machine = msm8x60_tenderloin_init,
	.timer = &msm_timer,
	.init_early = msm8x60_charm_init_early,
MACHINE_END
