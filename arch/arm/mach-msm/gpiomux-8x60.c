...
static struct gpiomux_setting lcdc_msm8x60_tenderloin_active_cfg = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_14MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting lcdc_msm8x60_tenderloin_suspend_cfg = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_14MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting lcdc_msm8x60_tenderloin_active_cfg_2m = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting lcdc_msm8x60_tenderloin_suspend_cfg_2m = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct msm_gpiomux_config msm8x60_tenderloin_gsbi_configs[] __initdata = {
	{
		.gpio     = 43,
		.settings = {
...
#if defined(CONFIG_USB_PEHCI_HCD) || defined(CONFIG_USB_PEHCI_HCD_MODULE)
static struct msm_gpiomux_config msm8x60_tenderloin_ebi2_configs[] __initdata = {
	{
		.gpio     = 40,
		.settings = {
			[GPIOMUX_SUSPENDED] = &ebi2_cs2,
...
static struct msm_gpiomux_config msm8x60_tenderloin_uart_configs[] __initdata = {
	/* TODO: verify */
	{ /* UARTDM_TX */
		.gpio     = 53,
		.settings = {
...
static struct msm_gpiomux_config msm8x60_tenderloin_lcdc_configs[] __initdata = {
	{ /* lcdc_pclk */
		.gpio =     0,
		.settings = {
			[GPIOMUX_SUSPENDED] = &lcdc_msm8x60_tenderloin_suspend_cfg,
			[GPIOMUX_ACTIVE]    = &lcdc_msm8x60_tenderloin_active_cfg,
		},
	},
	{ /* lcdc_hsync */
		.gpio =     1,
	...
	{ /* lcdc_red7 */
		.gpio =     4,
		.settings = {
			[GPIOMUX_SUSPENDED] = &lcdc_msm8x60_tenderloin_suspend_cfg_2m,
			[GPIOMUX_ACTIVE]    = &lcdc_msm8x60_tenderloin_active_cfg_2m,
		},
	},
	{ /* lcdc_red6 */
		.gpio =     5,
...
struct msm_gpiomux_configs
msm8x60_tenderloin_gpiomux_cfgs[] __initdata = {
	{msm8x60_tenderloin_gsbi_configs, ARRAY_SIZE(msm8x60_tenderloin_gsbi_configs)},
	{msm8x60_tenderloin_uart_configs, ARRAY_SIZE(msm8x60_tenderloin_uart_configs)},
	{msm8x60_tenderloin_lcdc_configs, ARRAY_SIZE(msm8x60_tenderloin_lcdc_configs)},
#if 0
#if defined(CONFIG_USB_PEHCI_HCD) || defined(CONFIG_USB_PEHCI_HCD_MODULE)
	{msm8x60_tenderloin_ebi2_configs, ARRAY_SIZE(msm8x60_tenderloin_ebi2_configs)},
	{msm8x60_isp_usb_configs, ARRAY_SIZE(msm8x60_isp_usb_configs)},
#endif
	{msm8x60_aux_pcm_configs, ARRAY_SIZE(msm8x60_aux_pcm_configs)},
	{msm8x60_snd_configs, ARRAY_SIZE(msm8x60_snd_configs)},
